...
const AIPicker = ({prompt, setPrompt, generatingImg, handleSubmit}) => {
  return (
      <div className='aipicker-container'>
        <textarea placeholder='Aski Ai...' rows={5} value={prompt} onChange={(e)=> setPrompt(e.target.value)} className='aipicker-textarea'/>
        <div className='flex flex-warp gap-3'>
          {generatingImg ? (
            <CustomButton type='otuline' title="Asking AI.." customStyles="text-xs"/>
          ) : (
            <>
